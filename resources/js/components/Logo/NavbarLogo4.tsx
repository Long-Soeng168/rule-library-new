                ...
                <div className="flex flex-col max-[450px]:hidden">
                    {name && (
                        <div className="whitespace-nowrap">
                            ...
                            {/* <p className="text-xs leading-tight font-semibold text-foreground md:text-lg">{website_info.name_kh}</p> */}
                            {/* <p className="leading-tight font-semibold text-foreground md:text-xs">{name}</p> */}
                        </div>
                    )}
                </div>
            </div>
